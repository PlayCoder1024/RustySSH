...
pub fn render_state(frame: &mut Frame, state: &RenderState, area: Rect) {
    ...
    let help_text = vec![
        Line::from(vec![
            Span::styled("RustySSH", Style::default().add_modifier(Modifier::BOLD).fg(theme.accent_primary())),
            Span::styled(" - Terminal SSH Connection Manager", theme.text()),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled(" Global Shortcuts", Style::default().add_modifier(Modifier::BOLD).fg(theme.fg_bright())),
        ]),
        Line::from(""),
        Line::from(vec![
...
pub fn render(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let help_text = vec![
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled(" Global Shortcuts", Style::default().add_modifier(Modifier::BOLD | Modifier::UNDERLINED).fg(theme.fg_bright())),
        ]),
        Line::from(""),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled(" Navigation", Style::default().add_modifier(Modifier::BOLD | Modifier::UNDERLINED).fg(theme.fg_bright())),
        ]),
        Line::from(""),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled(" Views", Style::default().add_modifier(Modifier::BOLD | Modifier::UNDERLINED).fg(theme.fg_bright())),
        ]),
        Line::from(""),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled(" Connection Actions", Style::default().add_modifier(Modifier::BOLD | Modifier::UNDERLINED).fg(theme.fg_bright())),
        ]),
        Line::from(""),
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled(" Session Shortcuts", Style::default().add_modifier(Modifier::BOLD | Modifier::UNDERLINED).fg(theme.fg_bright())),
        ]),
        Line::from(""),
